...
final class FileManagementTests: XCTestCase {
    ...
    func testDeleteMultipleRecordings() async throws {
    ...
    func testCleanupOldRecordings() async throws {
    ...
    func testCreateRecordingDirectory() async throws {
    ...
    func testRecordingDirectoryExists() async throws {
