...
#ifndef SCREENMUSECORE_SWIFT_H
#define SCREENMUSECORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScreenMuseCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ScreenMuseCore19PiPRecordingManager")
@interface PiPRecordingManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class SCStream;
@interface PiPRecordingManager (SWIFT_EXTENSION(ScreenMuseCore)) <SCStreamOutput>
...
SWIFT_CLASS("_TtC14ScreenMuseCore16RecordingManager")
@interface RecordingManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface RecordingManager (SWIFT_EXTENSION(ScreenMuseCore)) <SCStreamDelegate>
- (void)stream:(SCStream * _Nonnull)stream didStopWithError:(NSError * _Nonnull)error;
@end

@interface RecordingManager (SWIFT_EXTENSION(ScreenMuseCore)) <SCStreamOutput>
